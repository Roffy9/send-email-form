					...
					<div class="container">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="/agentlist_eng" target="_blank">Agent</a>

									</li>
									<li><a href="form.php">Agent Form</a></li>
			...
			<div class="container content">
				<div class="row margin-bottom-30">
					...
					<div class="col-md-12 mb-margin-bottom-30">
						...
						<form action="form_submit.php" method="post" class="sky-form sky-changes-3">
							<fieldset>
								<div class="row">
								...
								<div class="row">
									...
									<section class="col col-6">
										<label class="label">Others Phone Number</span></label>
										<label class="input">
											<i class="icon-append fa fa-mobile"></i>
								...
								<div class="row">
									<section class="col col-6">
										<label class="label">Province<span style="color:red">*</span></label>
										<label class="input">
									...
									<section class="col col-6">
										<label class="label">Township<span style="color:red">*</span></label>
										<label class="input">
								...
								<div class="row">
									...
									<section class="col col-6">
										...
										<label class="input">
											<i class="icon-append fa fa-map-marker"></i>
											<input type="text" name="direction" tabindex="8">
										</label>
									</section>
								</div>
							</fieldset>
