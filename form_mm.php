					...
					<div class="container" style="width:100%;">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li >
										<a href="/agentlist_mm" target="_blank"> ကိုယ္စားလွယ္မ်ား</a>
									</li>
									<li><a href="form_mm.php">ေလွ်ာက္ထားရန္</a></li>
									<li><a href="terms&conditions_mm.php">စည္းကမ္းသတ္မွတ္ခ်က္မ်ား</a></li>
								</ul>
							</li>
							<!-- End Features -->
							<li class="dropdown">
			...
			<div class="container content">
				<div class="row margin-bottom-30">
					<div class="col-md-12 mb-margin-bottom-30">
						<div class="headline"><h2>Agent Form (TrueMoney Myanmar) </h2></div>
						<!-- <p>This is the Pre-Agent Agreement Form. Agents can send with email directly.</p><br> -->

						<form action="form_submit_mm.php" method="post" class="sky-form sky-changes-3">
							<fieldset>
								<div class="row">
									<section class="col col-6">
										<label class="label">နာမည္<span style="color:red">*</span></label>
										<label class="input">
											<i class="icon-append far fa-user"></i>
											<input type="text" name="name"  required tabindex="1"autofocus>
										</label>
									</section>
									<section class="col col-6">
										<label class="label">အီးေမးလ္လိပ္စာ</label>
										<label class="input">
								...
								<div class="row">
									<section class="col col-6">
										<label class="label">ဖုန္းနံပါတ္<span style="color:red">*</span></label>
										<label class="input">
											<i class="icon-append fa fa-mobile"></i>
											<input type="text" name="phone1" required tabindex="3">
										</label>
									</section>
									<section class="col col-6">
										<label class="label">အျခားဖုန္းနံပါတ္</label>
										<label class="input">
											<i class="icon-append fa fa-mobile"></i>
											<input type="text" name="phone2" tabindex="4">
										</label>
									</section>
								</div>
								<div class="row">
									<section class="col col-6">
										<label class="label">ျပည္နယ္/တုိင္း<span style="color:red">*</span></label>
										<label class="input">
											<i class="icon-append  fa fa-reorder"></i>
											<input type="text" name="province" required tabindex="5">
										</label>
									</section>
									<section class="col col-6">
										<label class="label">ျမိဳ႕နယ္<span style="color:red">*</span></label>
										<label class="input">
											<i class="icon-append fa fa-line-chart"></i>
											<input type="text" name="township" required tabindex="6">
										</label>
									</section>
								</div>
								...
								<div class="row">
									<section class="col col-6">
										<label class="label">ေနရပ္လိပ္စာ<span style="color:red">*</span></label>
										<label class="input">
											<i class="icon-append fa fa-map-marker"></i>
											<input type="text" name="address" required tabindex="7">
										</label>
									</section>
									<section class="col col-6">
										<label class="label">လမ္းၫႊန္</label>
										<label class="input">
											<i class="icon-append fa fa-map-marker"></i>
											<input type="text" name="direction" tabindex="7">
										</label>
									</section>
								</div>
							</fieldset>
